...
Третий модуль находится в папке `03-application-development` и посвящен пошаговой реализации MVP приложения по плану: backend API, frontend-интерфейс, локальное хранение данных, AI-функции в мок-режиме и базовые frontend-автотесты без Playwright.
